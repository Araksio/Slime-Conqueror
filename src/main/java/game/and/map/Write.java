...
public class Write {
	...
	/**
	 * La classe write recupere aleatoirement un fichier map qu'il reecrit dans le
	 * fichier de la map de jeu.
	 * 
	 * @param nbrLevel
	 ...
	 */
	private int countFiles(String parent) {// regarde le nombre de spyte existant pour qu'il soit tousse possiblement
											// choisie
