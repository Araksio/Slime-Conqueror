...
/**
 * cette classe permet la création et la modification du level associer a un
 * joueur
 * 
 * @author Pitohui.G7
 *
...
public class LV {
	...
	// fonction qui permet de savoir en fonction de l'xp du joueur si il peu monter
	// au prochain level et augmente le level si c'est possible
