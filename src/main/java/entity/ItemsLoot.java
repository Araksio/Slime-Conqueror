...
public class ItemsLoot extends Item {
	...
	ItemsLoot(int _UniqueID, int _ID, int _inventoryID, String _Nom, int _Type, int _CurrentDurability,
			int _MaxDurability, Rarity _RarityOfItems) {
		super(_UniqueID, _ID, _inventoryID, _Nom, 5, 1, 1);
		RarityOfItems = _RarityOfItems;
	}

	ItemsLoot(int _UniqueID, int _ID, int _inventoryID, String _Nom, int _Type, int _CurrentDurability,
			int _MaxDurability, String _Description, Rarity _RarityOfItems) {
