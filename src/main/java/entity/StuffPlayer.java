...
/**
 * cette classe permet la création et la modification du Stuff (Equipement)
 * porter par le Joueur
 * 
 * @author Pitohui.G7
 *
 */
...
public class StuffPlayer {
	...
	StuffPlayer(Item _CurrentMainWeapons, Item _CurrentSecondaryWeapons, Item _CurrentCasque, Item _CurrentPlastron,
			Item _CurrentJambiere, Item _CurrentBottes, Item _CurrentCollier, Item _CurrentBracelet) {
