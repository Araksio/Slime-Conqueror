...
/**
 * cette classe permet d'avoir des position prédéfini utilisable pour le joueur
 *
 * @author Pitohui.G7
 *
 */
...
public class Pos {
	...
	public void showPos() {
		println("Position Actuelle du joueur dans le monde " + this.getCurrentMapID() + " a l'�tage num�ro "
				+ this.getFloor());
	...
	// deplacement generique de 1 cas par appel de methode
	...
	// deplacement Version 2 qui permet de ce deplacer de plusieurs case en un seul
	// appel de methode
	...
	public void setFloor(int _Floor) {
		// Verification que l'etage existe
		this.floor = _Floor;
	}
