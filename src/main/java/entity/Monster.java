...
/**
 * cette classe comporte les diférentes varibles importante pour le
 * fonctionement des monstres en jeu
 * 
 * @author Pitohui.G7
 */
public class Monster extends Entiter {
	...
	public Monster(String _nom, Pos _position, Stat _statistiques, GameType _entityType, MonsterType _state,
			Double _droppedXP) {
