...
/**
 * Cette classe permet de créer les menus du jeu
 * Elle est composé de son layout, un AnchorPane
 * @author Gaël
 *
 */
public class MyMenu extends FXGLMenu {
	...
	/**
	 * Constructeur permettant de récupérer le type du menu
	 * et de créer le menu selon le type récupérer.
	 * @author Gaël
	 * @param type
	 *            Le type du menu
	 * @throws IOException : Si il y a un problème pour charger notre FXML (graphique)
	 */
 ...
 */
    ...
    /*
     * Nous n'utilisons pas ces méthodes mais elles sont obligatoirement
     * présente pour faire fonctionner le extends
     */
    @Override
