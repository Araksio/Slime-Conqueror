...
/**
 * @author Gaël MyGameMenuController permet de générer un menu pause en jeu. Ce
 *         menu est composé de :
 * 
 *         Un boutton pour reprendre la partie Un boutton options Un boutton
 *         revenant au menu principal Un boutton pour quitter le jeu.
 */
public class MyGameMenuController {
	...
	/**
	 * @author Gaël On initialise le fonctionnement des bouttons.
	 */
	@FXML
	private void initialize() {
		/*
		 * Lorsque l'on passe notre souris sur un des bouttons, On joue un petit son et
		 * le boutton devient orangé Puis lorsque l'on quitte le boutton, il reprends sa
		 * couleur originelle.
		 */
	...
	/**
	 * @author Gaël Cette méthode permet de jouer un petit son lorsqu'elle est
	 *         appelé.
	 */
	public void buttonSFX() {
		AudioClip a1 = new AudioClip(getClass().getResource("/SFX/buttonSound.mp3").toString()); // On cherche le son en
																									// .mp3 dans SFX
		a1.play(); // Et on le joue
	}

	/**
	 * @author Gaël Cette méthode permet de reprendre le jeu lorsqu'elle est appelé
	 */
	@FXML
	...
	/**
	 * @author Gaël Cette méthode permet de revenir au menu principal lorsqu'elle
	 *         est appelé
	 */
	@FXML
	...
	/**
	 * @author Gaël Cette méthode permet de quitter le jeu lorsqu'elle est appelé
	 */
	@FXML
