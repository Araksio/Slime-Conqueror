...
private void startGame() throws SQLException {
	...
	//maintenant que tout est supprimé, on recree
			...
			demandeRequete.executeUpdate("INSERT INTO `projetpoagl`.`lvl` (`idLvl`, `level`, `totalXP`, `currentXP`, `xpNeeded`, `idjoueur`, `idmonstre`,`pointBonus`) VALUES ('2', '2', '20', '0', '60', NULL, NULL,'1')");
			...
			demandeRequete.executeUpdate("INSERT INTO `projetpoagl`.`lvl` (`idLvl`, `level`, `totalXP`, `currentXP`, `xpNeeded`, `idjoueur`, `idmonstre`,`pointBonus`) VALUES ('4', '4', '280', '0', '500', NULL, NULL,'2')");
