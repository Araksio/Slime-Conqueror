...
/**
 * MyManuMenuController permet de générer le menu principale en jeu. Ce menu est
 * composé de :
 * 
 * Un boutton pour commencer une nouvelle partie Un boutton pour continuer une
 * partie Un boutton options Un boutton pour quitter le jeu.
 * 
 * @author Gaël
 *
 */
public class MyMainMenuController {
	...
	private void initialize() {
		...
		/*
		 * Lorsqu'on appuie sur nouvelle partie, on ouvre une nouvelle fenêtre séléction
		 * de pseudo.
		 */
